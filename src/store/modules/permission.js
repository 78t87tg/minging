  ...
  actions: {
    ...
    GenerateRoutes({ commit }) {
      return new Promise(resolve => {
          ...
          const sdata = JSON.parse(JSON.stringify(a))
          const rdata = JSON.parse(JSON.stringify(a))
